...
public class SequentialSearchCSV {
    public static void main(String[] args) throws IOException {
        ...
        // pemanggilan function SequentialSearching
        SequentialSearching(fileName, value);
    ...
    public static void SequentialSearching(String fileName, String[][] value) throws IOException {
        ...
        if (search) {
            ...
            System.out.println("data nya adalah " + key + " " + value[i]);
        } else {
